...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference("Genre.count") do
      post genres_url, params: { genre: { description_genre: @genre.description_genre, name_genre: @genre.name_genre } }
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { description_genre: @genre.description_genre, name_genre: @genre.name_genre } }
