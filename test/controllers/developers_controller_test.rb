...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference("Developer.count") do
      post developers_url, params: { developer: { description_developer: @developer.description_developer, name_developer: @developer.name_developer } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { description_developer: @developer.description_developer, name_developer: @developer.name_developer } }
