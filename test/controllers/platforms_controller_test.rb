...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference("Platform.count") do
      post platforms_url, params: { platform: { description_platform: @platform.description_platform, name_platform: @platform.name_platform } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { description_platform: @platform.description_platform, name_platform: @platform.name_platform } }
