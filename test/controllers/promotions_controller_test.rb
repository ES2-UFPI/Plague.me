...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference("Promotion.count") do
      post promotions_url, params: { promotion: { description: @promotion.description, end_date: @promotion.end_date, start_date: @promotion.start_date, title: @promotion.title } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { description: @promotion.description, end_date: @promotion.end_date, start_date: @promotion.start_date, title: @promotion.title } }
